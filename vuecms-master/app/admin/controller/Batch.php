...
class Batch extends Admin {
	...
	function index(){
		if (!$this->request->isPost()){
			...
			$field = 'batch_id,title,sex,status,amount,wb,bq,sortid,jsq';
 	...
 	*/
	public function add(){
		$postField = 'title,sex,status,amount,wb,bq,sortid,jsq';
		$data = $this->request->only(explode(',',$postField),'post',null);
	...
	public function update(){
		$postField = 'batch_id,title,sex,status,amount,wb,bq,sortid,jsq';
		$data = $this->request->only(explode(',',$postField),'post',null);
